...
export default class Dom {
	 ...
	 */
	static button(text: string, callback?: (ev: MouseEvent) => void, className?: string): HTMLButtonElement {
	 ...
	 */
	static input(type: string, placeholder?: string, defaultValue?: string, className?: string): HTMLInputElement {
